...
export type testDbConnectionDbTestGetResponseSuccess = (testDbConnectionDbTestGetResponse200) & {
  headers: Headers;
};
;

export type testDbConnectionDbTestGetResponse = (testDbConnectionDbTestGetResponseSuccess)
...
export const testDbConnectionDbTestGet = async ( options?: RequestInit): Promise<testDbConnectionDbTestGetResponse> => {
  
  return customFetch<testDbConnectionDbTestGetResponse>(getTestDbConnectionDbTestGetUrl(),
  {      
    ...options,
    method: 'GET'
